            ...
            while True:
                if self.plc_connection:
                    ...
                    if plc_flag == 1 or plc_flag == 2:
                        ...
                        data = {
                            "message1": "nobel TEST DATA1",
                            "message2": "nobel TEST DATA2",
                            "message3": "nobel TEST DATA3",
                            "message4": "nobel TEST DATA",
                            "message5": "nobel TEST DATA",
                            "message6": "nobel TEST DATA",
                            "image": image_base64
                        }
...
if __name__ == "__main__":
    ...
    server = Server(FLUTTER_HOST, FLUTTER_PORT, PLC_IP, PLC_FLAG_TAG, PLC_DATA_TAG, 1, 1)
    server.start()